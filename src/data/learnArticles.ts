...
export const learnArticles: LearnArticle[] = [
  {
    ...
    sections: [
      ...
      { heading: "Official local guidance comes first", paragraphs: ["OpenRisk Radar summarizes public feeds for situational awareness. It is not an emergency notification service. During dangerous weather, use official alert channels and follow instructions from local authorities and the issuing weather service."] },
    ],
    sources: [
